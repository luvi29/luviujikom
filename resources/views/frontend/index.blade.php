                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        ...
                                        <a class="dropdown-item" href="./product_list">product details</a>
                ...
                <div class="col-lg-12">
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_img">
                                    <img src="{{ asset ('assets/frontend/pillowmart/pillowmart/img/ibnu.jpg')}}" class="img-fluid" alt="#">

                                </div>
                            </div>
                            <div class="col-lg-5 col-sm-6">
                                <div class="single_product_content">
                                    <h5>from Rp1.5000.00</h5>
                                    <h2> <a href="single-product.html">Kitab Tafsir Ibnu Katsir</a> </h2>
                    ...
                    <div class="single_product_iner">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_img">
                                    <img src="{{ asset ('assets/frontend/pillowmart/pillowmart/img/maram.jpg')}}" class="img-fluid" alt="#">
                                </div>
                            </div>
                            <div class="col-lg-5 col-sm-6">
                                <div class="single_product_content">
                                    <h5>from Rp1.360.000</h5>
                                    <h2> <a href="single-product.html">Terjemah Bulughul Maram</a> </h2>
                                    <a href="./product_list" class="btn_3">Explore Now</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="single_product_iner">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_img">
                                    <img src="{{ asset ('assets/frontend/pillowmart/pillowmart/img/showi.jpg')}}" class="img-fluid" alt="#">

                                </div>
                            </div>
                            <div class="col-lg-5 col-sm-6">
                                <div class="single_product_content">
                                    <h5>from Rp1000.000</h5>
                                    <h2> <a href="single-product.html">Kitab Showi</a> </h2>
                                    <a href="./product_list" class="btn_3">Explore Now</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        ...
                        <h3> <a href="./product_list">Kitab Ahlaq</a> </h3>
                        <p>From Rp20.000</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        ...
                        <h3> <a href="./product_list">Kitab Safinah</a> </h3>
                        <p>From Rp20.000</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        ...
                        <h3> <a href="./product_list">Kitab Tijan</a> </h3>
                        <p>From Rp20.000</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        ...
                        <h3> <a href="./product_list">Kitab Qurotuluyun</a> </h3>
                        <p>From Rp20.000</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        ...
                        <h3> <a href="./product_list">Kitab Fathulizar</a> </h3>
                        <p>From Rp20.000</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_product_item">
                        ...
                        <h3> <a href="./product_list">Terjemahan Kitab Talim Mutaalim</a> </h3>
                        <p>From Rp25.000</p>
                    </div>
                </div>
            </div>
